...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp8(XLua.LuaTable p0, string p1, int p2, float p3)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp9(XLua.LuaTable p0, int p1, float p2, float p3, float p4, float p5, float p6)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp10(XLua.LuaTable p0, int p1, float p2, float p3)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp12(XLua.LuaTable p0, int p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp16(int p0, XLua.LuaTable p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp17(Gesture p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp18(XLua.LuaTable p0, AssetLoaderBase p1, bool p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(InputManager.KeyCallback))
			{
			    return new InputManager.KeyCallback(__Gen_Delegate_Imp8);
			}
		
		    if (type == typeof(InputManager.TouchCallback))
			{
			    return new InputManager.TouchCallback(__Gen_Delegate_Imp9);
			}
		
		    if (type == typeof(InputManager.AxisCallback))
			{
			    return new InputManager.AxisCallback(__Gen_Delegate_Imp10);
			}
		
		    if (type == typeof(LuaEventUtility.NoTableDelegate))
			{
			    return new LuaEventUtility.NoTableDelegate(__Gen_Delegate_Imp11);
			}
		
		    if (type == typeof(LuaEventUtility.TableDelegate))
			{
			    return new LuaEventUtility.TableDelegate(__Gen_Delegate_Imp12);
			}
			...
			{
			    return new System.Action<int, XLua.LuaTable>(__Gen_Delegate_Imp16);
			}
		
		    if (type == typeof(System.Action<Gesture>))
			{
			    return new System.Action<Gesture>(__Gen_Delegate_Imp17);
			}
		
		    if (type == typeof(System.Action<XLua.LuaTable, AssetLoaderBase, bool>))
			{
			    return new System.Action<XLua.LuaTable, AssetLoaderBase, bool>(__Gen_Delegate_Imp18);
			}
			...
			{
			    return new System.Action<UnityEngine.Vector2>(__Gen_Delegate_Imp21);
			}
